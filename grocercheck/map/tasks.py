...
def update_current_popularity(country, doBackup, doLog, proxy, num_processes):
    run_scraper(country, doBackup = doBackup, doLog = doLog, proxy = proxy, num_processes = num_processes)
